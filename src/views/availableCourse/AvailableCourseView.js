		...
		try {
			...
			const data = {
				...
				chooseWhatYouWantToKnowAbout:
					inputValues.choose_what_you_want_to_know_about,
			};
					...
					<div className="row justify-content-between align-items-center">
						<div className="col-lg-6 col-md-6 search-course-left">
							<h1 className="text-white">
								Get quick response to
								<br />
								help you take a decision !
							</h1>
							<p className="text-white">
								Let us help you decide the best route for you, taking informed decision
								is why we are still in business, why not lets' help you get the
								information you need, so you can decide quickly.
							</p>
							<div className="row details-content">
								<div className="col single-detials">
									...
									<p className="text-white">
										Our team of Study Experts are ready to take you through to achieving
										success
									</p>
								</div>
								<div className="col single-detials">
									...
									<p className="text-white">
										With proven years of many experiences and abundant testimonies, our
										experts qualify to walk you through gaining admission!
									</p>
								</div>
							</div>
						</div>
