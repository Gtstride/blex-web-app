      ...
      <div className="sidebar-wrapper sidebar-theme">
        <nav id="sidebar">
          ...
          <ul className="list-unstyled menu-categories" id="accordionExample">
            ...
            <li className="menu md-visible menu-heading">
              ...
              >
                ...
                <li>
                  ...
                  >
                    ...
                    <li>
                      <a href="pages_maintenence.html" target="_blank">
                        {" "}
                        Maintanence{" "}
                      </a>
                    </li>
            ...
            <li className="menu">
              ...
              >
                ...
                <li>
                  <a href="auth_register_boxed.html" target="_blank">
                    {" "}
                    Register Boxed{" "}
                  </a>
                </li>
                <li>
                  <a href="auth_lockscreen_boxed.html" target="_blank">
                    {" "}
                    Unlock Boxed{" "}
                  </a>
                </li>
                <li>
                  <a href="auth_pass_recovery_boxed.html" target="_blank">
                    {" "}
                    Recover ID Boxed{" "}
                  </a>
                </li>
                ...
                <li>
                  <a href="auth_pass_recovery.html" target="_blank">
                    {" "}
                    Recover ID Cover{" "}
                  </a>
                </li>
