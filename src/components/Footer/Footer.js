				...
				<footer className="footer-area section-gap">
					<div className="container">
									...
									<ul>
										<li>
											<a href="https://wa.link/cmbwfj" target="_blank" rel="noreferrer">
												<Icon.Whatsapp size={36} color="green" />
											</a>
										</li>
									</ul>
								</div>
							...
							<div className="col-lg-4 col-md-6 col-sm-6 footer-social">
								<div className="single-footer-widget">
									...
									<a
										...
										rel="noreferrer"
									>
										<Icon.Facebook size={30} style={{ marginRight: "1.5em" }} />
									</a>
									<a
						...
						<div className="footer-bottom row align-items-center justify-content-between">
							<p className="footer-text m-0 col-lg-4 col-md-12"></p>
                  ...
                  marginRight: "8px",
							...
							<a
								href={url}
								className="true cd-top text-replace js-cd-top"
					...
					<div className="col-lg-6 col-sm-6 col-4 header-top-right no-padding"></div>
				</footer>
			</div>
		);
}
